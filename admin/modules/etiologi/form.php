...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=etiologi"> Artikel </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" method="POST" action="modules/etiologi/proses.php?act=insert" method="POST" enctype="multipart/form-data">
            <div class="box-body">
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-1 col-sm-11">
                  ...
                  <a href="?module=etiologi" class="btn btn-default btn-reset">Cancel</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
...
elseif ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT * FROM is_etiologi WHERE etiologi_id='$_GET[id]'") 
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" method="POST" action="modules/etiologi/proses.php?act=update" method="POST" enctype="multipart/form-data">
            <div class="box-body">
              
              <input type="hidden" name="etiologi_id" value="<?php echo $data['etiologi_id']; ?>">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  ...
                  <br>
                  <img src="../images/etiologi/<?php echo $data['image']; ?>" height="150">
                </div>
              </div>
