...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2022 at 10:50 AM
...
(1, 'Tentang TeleHealth', '<p><strong><span style=\"color:rgb(85, 85, 85); font-family:helvetica neue,helvetica,arial,sans-serif; font-size:20px\">TeleHealth&nbsp;</span></strong>merupakan sebuah aplikasi dan situs web asal Indonesia</p>\r\n\r\n<p><a href=\"https://id.wikipedia.org/wiki/Halodoc#cite_note-1\" style=\"text-decoration-line: none; color: rgb(6, 69, 173); background: none;\">[1]</a>&nbsp;yang bergerak di bidang kesehatan.<a href=\"https://id.wikipedia.org/wiki/Halodoc#cite_note-2\" style=\"text-decoration-line: none; color: rgb(6, 69, 173); background: none;\">[</a></p>\r\n\r\n<p><a href=\"https://id.wikipedia.org/wiki/Halodoc#cite_note-2\" style=\"text-decoration-line: none; color: rgb(6, 69, 173); background: none;\">2]</a>&nbsp;<strong>PT TeleHealth&nbsp;</strong>, perusahaan aplikasi ini didirikan pada tahun 2016 di Jakarta oleh Jonathan Sudharta.</p>\r\n\r\n<p><a href=\"https://id.wikipedia.org/wiki/Halodoc#cite_note-3\" style=\"text-decoration-line: none; color: rgb(6, 69, 173); background: none;\">[3]</a></p>\r\n\r\n<p>Hingga tahun 2018, total pendanaan yang diterima adalah sekitar US$13 juta atau sekitar Rp170 miliar; beberap</p>\r\n\r\n<p>a investornya atara lain&nbsp;<a href=\"https://id.wikipedia.org/wiki/Gojek\" style=\"text-decoration-line: none; color: rgb(6, 69, 173); background: none;\" title=\"Gojek\">Gojek</a>,&nbsp;<a href=\"https://id.wikipedia.org/wiki/Blibli\" style=\"text-decoration-line: none; color: rgb(6, 69, 173); background: none;\" title=\"Blibli\">Blibli</a>, Clermont, dan NSI Ventures.<a href=\"https://id.wikipedia.org/wiki/Halodoc#cite_note-4\" style=\"text-decoration-line: none; color: rgb(6, 69, 173); background: none;\">[4]</a>&nbsp;<strong>TeleHealth </strong>mengumumkan kerjasama dengan GO-JEK pada bulan Mei 2018.<a href=\"https://id.wikipedia.org/wiki/Halodoc#cite_note-5\" style=\"text-decoration-line: none; color: rgb(6, 69, 173); background: none;\">[5]</a>&nbsp;Melalui kerja sama tersebut GO-JEK akan menghubungkan fitur GO-MED di dalam aplikasi GO-JEK dengan aplikasi <strong>TeleHealth&nbsp;</strong>. Sehingga pengguna GO-JEK akan langsung diarahkan ke aplikasi <strong>TeleHealth</strong></p>\r\n\r\n<p><strong>&nbsp;</strong>untuk pemesanan kebutuhan medis seperti obat atau vitamin.</p>\r\n\r\n<p>Selain itu, <strong>TeleHealth&nbsp;</strong>juga menjalin kerjasama dengan beberapa perusahaan asuransi.</p>');

-- --------------------------------------------------------

--
-- Table structure for table `is_dm`
--
...
--
-- Dumping data for table `is_dm`
--

INSERT INTO `is_dm` (`dm_id`, `judul`, `isi`) VALUES
(1, 'Pengertian Penyakit Diabetes, Faktor Risiko, dan Cara Pencegahannya', '<p>Sebagaimana telah dilansir oleh liputan6.com, Pengertian penyakit diabetes adalah suatu kondisi dimana kadar glukosa atau gula darah meningkat atau di atas batas normal. Glukosa menumpuk di dalam darah akibat tidak diserap sel tubuh dengan baik sehingga dapat menimbulkan berbagai gangguan organ tubuh.</p>\r\n\r\n<p>Menurut WHO, Diabetes Melitus (DM) pengertian penyakit diabetes adalah suatu gangguan metabolisme kronis dengan multi etiologi yang ditandai dengan tingginya kadar gula darah disertai dengan gangguan metabolisme karbohidrat, lipid dan protein sebagai akibat dari insufisiensi fungsi insulin.</p>\r\n\r\n<p>Ya, pada penderita diabetes, pankreas tidak mampu memproduksi insulin sesuai dengan kebutuhan tubuh. Sedangkan tanpa insulin, sel-sel tubuh tidak dapat menyerap dan mengolah glukosa menjadi energi.</p>\r\n\r\n<p>Menurut data Badan Kesehatan Dunia (WHO), saat ini sudah ada sekitar 150 juta orang yang mengalami diabetes di seluruh belahan dunia. Maka tak heran, kalau penyakit diabetes semakin menjadi perhatian karena jumlah penderitanya yang terus bertambah.</p>\r\n\r\n<p>Sebagian besar penderitanya mengaku bahwa mereka baru menyadari adanya penyakit diabetes setelah muncul komplikasi serius seperti gangguan mata atau gangguan ginjal. Karenanya, mengetahui kehadiran penyakit ini sedini mungkin menjadi suatu hal yang sangat penting.</p>\r\n\r\n<p>Mengenal tentang Penyakit Diabetes</p>\r\n\r\n<p>Diabetes merupakan salah satu penyakit mematikan yang menjadi momok bagi semua orang. Hal ini dikarenakan penyakit diabetes berlangsung seumur hidup dan dapat menimbulkan sejumlah komplikasi bila penderita tidak mengendalikannya.</p>\r\n\r\n<p>Maka tak heran kalau penyakit diabetes semakin menjadi perhatian, karena jumlah penderitanya terus bertambah. Menurut WHO, sudah ada sekitar 150 juta orang yang mengalami diabetes di seluruh belahan dunia.</p>\r\n\r\n<p>Pengertian penyakit diabetes adalah suatu penyakit yang terjadi akibat kegagalan sel pankreas dalam memproduksi insulin. Hormon insulin inilah yang berfungsi dalam mengatur penggunaan gula untuk aktivitas sel-sel di dalam tubuh.</p>\r\n\r\n<p>Nah, pada pasokan insulin yang tidak memadai ini nantinya akan menyebabkan kadar gula darah cenderung tinggi. Pada pengertian penyakit diabetes ini apabila kondisinya secar terus-menerus dapat menyebakan kerusakan pada dinding pembuluh darah dan mengakibatkan komplikasi pada berbagai organ penting di dalam tubuh seperti jantung koroner, stroke, obesitas, serta gangguan pada mata, ginjal, dan saraf.</p>\r\n\r\n<p>Selain itu, pengertian penyakit diabetes juga dapat menyebabkan terjadinya fluktuasi kadar gula darah dalam tubuh. Hal ini dapat mengakibatkan penurunan (hipoglikemia) atau peningkatan kadar gula darah (hiperglikemia) secara tiba-tiba.</p>\r\n\r\n<p>Gejala Umum yang Dirasakan Penderita Diabetes<br />\r\nMudah Lapar</p>\r\n\r\n<p>Gejala klasik diabetes yang mungkin terjadi adalah mudah lapar. Ya, di awal diabetes, penderitanya akan merasakan lapar secara berlebihan sekalipun sudah makan dengan teratur. Hal ini disebabkan karena makanan yang dikonsumsi sulit diubah menjadi energy akibat kekurangan hormone insulin.</p>\r\n\r\n<p>Mudah Haus</p>\r\n\r\n<p>Penderita diabetes biasanya akan mudah merasakan haus, sehingga minum air menjadi lebih sering. Hal ini berhubungan dengan jumlah buang air kecil yang sering.</p>\r\n\r\n<p>Sering Buang Air Kecil</p>\r\n\r\n<p>Saat kadar gula darah terlalu tinggi, tubuh akan berusaha untuk mengeluarkannya melalui urie. Itulah sebab kenapa oenderita diabetes akan lebih sering buang air kecil. Hal ini pula yang kemudian menyebabkannya menjadi lebih sering haus.</p>\r\n\r\n<p>Faktor Risiko Diabetes Tipe 1</p>\r\n\r\n<p>Secara umum, pengertian penyakit diabetes dibedakan menjadi dua jenis, yaitu diabetes tipe 1 dan tipe 2. Diabetes tipe 1 ini terjadi karena sistem kekebalan tubuh penderita menyerang dan menghancurkan sel-sel pankreas yang memproduksi insulin. Hal inilah yang mengakibatkan peningkatan kadar glukosa darah, sehingga terjadi kerusakan pada organ-organ tubuh.</p>\r\n\r\n<p>Seseorang akan lebih mudah mengalami diabetes tipe 1 jika memiliki faktor risiko seperti berikut ini:</p>\r\n\r\n<p>&ndash; Memiliki keluarga dengan riwayat diabetes tipe 1.<br />\r\n&ndash; Menderita infeksi virus.<br />\r\n&ndash; Orang berkulit terang diduga lebih mudah mengalami diabtes tipe 1 dibandingkan ras lain.<br />\r\n&ndash; Diabetes tipe 1 banyak terjadi pada usia 4-7 tahun dan 10-14 tahun, walaupun diabetes tipe 1 dapat muncul pada usia berapapun.</p>\r\n\r\n<p>Faktor Risiko Diabetes Tipe 2</p>\r\n\r\n<p>Sedangkan pada diabetes tipe 2 merupakan jenis diabetes yang lebih sering terjadi. Diabetes jenis ini disebabkan oleh sel-sel tubuh yang menjadi kurang sensitif terhadao insulin, sehingga insulin yang dihasilkan tidak dapat digunakan dengan baik.</p>\r\n\r\n<p>Pada kasus diabetes tipe 2, seseorang akan lebih mudah mengalami kondisi ini jika memiliki faktor risiko seperti:</p>\r\n\r\n<p>&ndash; Kelebihan berat badan.<br />\r\n&ndash; Memiliki keluarga dengan riwayat diabetes tipe 2.<br />\r\n&ndash; Kurang aktif. Pasalnya aktivitas fisik ini membantu mengontrol berat badan, membakar glukosa sebagai energi, dan membuat sel tubuh lebih sensitif terhadap insulin. Jadi, kalau kurang aktif bergerak, seseorang bisa lebih mudah terkena diabetes tipe 2 ini.<br />\r\n&ndash; Bertambahnya usia.<br />\r\n&ndash; Menderita tekanan darah tinggi.<br />\r\n&ndash; Memiliki kadar kolesterol dan trigliserida abnormal. Seseorang yang memiliki kadar kolesterol baik atau HDL yang rendah dan kadar trigliserida yang tinggi lebih berisiko mengalami diabetes tipe 2.</p>\r\n\r\n<p>Cara Mencegah Penyakit Diabetes</p>\r\n\r\n<p>Setelah memahami pengertian penyakit diabetes, gejala penyakit diabetes, serta faktor yang mempengaruhinya, maka taka da salahnya bagi kamu untuk menghindari atau mencegah penyakit diabetes mulai sejak dini.</p>\r\n\r\n<p>Apalagi buat kamu yang memiliki faktor risiko diabetes, maka sangat penting untuk melakukan pencegahan diabetes. Misalnya saja jika kamu kelebihan berat badan atau mempunyai keluarga dengan riwayat diabetes.</p>\r\n\r\n<p>Maka untuk menghindarinya, kamu bisa menerapkan pola hidup sehat sebagai kunci utamanya. Mengonsumsi makanan sehat dan bergizi seimbang, berolahraga secara teratrur, dan menjaga berat badan agar tetap ideal.</p>\r\n\r\n<p>Sumber Link : https://hot.liputan6.com/read/4021182/pengertian-penyakit-diabetes-faktor-risiko-dan-cara-pencegahannya</p>');

-- --------------------------------------------------------

--
-- Table structure for table `is_etiologi`
--

CREATE TABLE `is_etiologi` (
  `etiologi_id` int(11) NOT NULL,
...
--
-- Dumping data for table `is_etiologi`
--

INSERT INTO `is_etiologi` (`etiologi_id`, `title`, `deskripsi`, `image`) VALUES
(1, 'test asdasd', 'test etiologi', 'master_3P093asOQ4_1550_ayu_ting_ting.jpg'),
(4, 'asdasdasd', '<p>asdasdasdasd</p>', 'FW6rcbAf2v.jpg');
...
--
-- Table structure for table `is_resiko`
--

CREATE TABLE `is_resiko` (
...
--
-- Dumping data for table `is_resiko`
--

INSERT INTO `is_resiko` (`resiko_id`, `title`, `deskripsi`, `image`) VALUES
(1, 'aaaaaaaaaaaaaaresiko DM', 'test resiko DM', 'giaa.jpg');
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'TeleHealth');
...
--
-- Indexes for table `is_dm`
--
ALTER TABLE `is_dm`
  ADD PRIMARY KEY (`dm_id`);

--
-- Indexes for table `is_etiologi`
--
ALTER TABLE `is_etiologi`
  ADD PRIMARY KEY (`etiologi_id`);
...
--
-- Indexes for table `is_resiko`
--
ALTER TABLE `is_resiko`
  ADD PRIMARY KEY (`resiko_id`);
...
--
-- AUTO_INCREMENT for table `is_dm`
--
ALTER TABLE `is_dm`
  MODIFY `dm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `is_etiologi`
--
ALTER TABLE `is_etiologi`
  MODIFY `etiologi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `is_resiko`
--
ALTER TABLE `is_resiko`
  MODIFY `resiko_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
