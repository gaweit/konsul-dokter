...
<div class="row">
    <div class="col-lg-12">
        <div class="row">
            ...
            $jumlah_record = mysqli_query($mysqli, "SELECT * FROM is_etiologi")
            ...
            $query = mysqli_query($mysqli, "SELECT * FROM is_etiologi ORDER BY etiologi_id DESC LIMIT $mulai, $batas")
